    ...
    <div className="bg-[#140735]">
            ...
            <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-[#2C333F]">
                ...
                <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-[#2C333F] pl-3 lg:pr-5 gap-3">
                    <div className="w-[30%] flex flex-col gap-3 lg:w-[30%] mb-7 lg:pl-0">
                        <img src={LogoImage} alt="cybermass.ai" className="object-contain"/>
                        ...
                        <div className="flex flex-col gap-2">
                            {
                                ["About", "Careers", "Affiliates"].map((element, index) => {
                                    return (
                                        <div 
                                            key={index}
                                            className="text-[14px] text-[#C5C7D4] cursor-pointer hover:text-[#C5C7D4] transition-all duration-200"
                                        >
                    ...
                    <div className="w-[48%] lg:w-[30%] mb-7 lg:pl-0">
                        ...
                        <div className="text-[14px] text-[#C5C7D4] cursor-pointer hover:text-richblack-50 transition-all duration-200 mt-2">
                            <Link to={"/help-center"}>Help Center</Link>
                        </div>
                    </div>

                    <div className="w-[48%] lg:w-[30%] mb-7 lg:pl-0">
                        <h1 className="text- font-semibold text-[16px]">Plans</h1>
                        <div className="flex flex-col gap-2 mt-2">
                            {
                                Plans.map((element, index) => {
                                    return (
                                        <div
                                            key={index}
                                            className="text-[14px] text-[#C5C7D4] cursor-pointer hover:text-richblack-50 transition-all duration-200"
                                        >
                                            <Link to={element.split(" ").join("-").toLowerCase()}>{element}</Link>
                                        </div>
                                    )
        ...
        <div className="flex flex-row items-center justify-between w-11/12 max-w-maxContent text-richblack-400 mx-auto  pb-14 text-sm">
            <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
                <div className="flex flex-row text-[#C5C7D4]">
                    {
                ...
                <div className="text-[#C5C7D4]">@ Copyright 2024 | <HighlightText text={"Cybermass.ai"} /> | All Rights Reserved</div>
            </div>
        </div>
    </div>
  )
